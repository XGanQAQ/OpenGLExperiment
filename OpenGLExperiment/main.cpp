...
void init(GLFWwindow* window) {
	renderingProgram1 = Utils::createShaderProgram("assets/shaders/vert1Shader.glsl", "assets/shaders/frag1Shader.glsl");
	renderingProgram2 = Utils::createShaderProgram("assets/shaders/vert2Shader.glsl", "assets/shaders/frag2Shader.glsl");
